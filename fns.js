...
function makeDownLoadBtn() {
  ...
  btn.onclick = function () {
    location.href = rootPath + "/data/epw/rc3_0/rc3_0.zip";
  }; // Create a text node
...
function onelineLink(name, href) {
  ...
  link.innerHTML = name;
  if (href.indexOf("#") > -1 || href.indexOf("http") > -1) link.href = href;
  else link.href = rootPath + href;
  return link;
}
function makeFooter() {
  ...
  var contentsection = makeSection();
  var p = makeContentElement(
    "04 08 2019 info[a]clima-colombia.org",
    "",
    6,
    "date",
    "h4",
...
function herramPage() {
  ...
  var contentsection = makeSection();
  var p = makeContentElement(
    "Gridded monthly data, climate / altitude / comfort for Colombia",
    "/img/t28.jpg",
    1.5,
    "gridded1",
    "h2",
  ...
  var a = makeContentElement(
    "Gridded, bivariate monthly data, climate / altitude / comfort for Colombia",
    "/img/t25.jpg",
    1.5,
    "gridded2",
    "h2",
  ...
  var c = makeContentElement(
    "climaJSON standard for online climatic data",
    "/img/t16.jpg",
    1.5,
    "clima",
    "h2",
  ...
  var contentsection = makeSection();
  var p = makeContentElement(
    "References, sources and legal",
    selectRandomImage(),
    1.5,
    "refs",
    "h2",
    "third",
    "/tools/refs/refs.html"
  );
  var a = makeContentElement(
    "Access to climaJSON versions of all *.epw",
    selectRandomImage(),
    1.5,
    "climajson",
    "h2",
  ...
  var c = makeContentElement(
    "Map of meteorological stations in Colombia",
    "img/t30.jpg",
    1.5,
    "map",
    "h2",
  ...
  var contentsection = makeSection();
  var p = makeContentElement(
    "Monthly averages for Colombia 2000 a 2009",
    selectRandomImage(),
    1.5,
    "refs",
    "h2",
  ...
  var contentsection = makeSection();
  var c = makeContentElement(
    "k-means clustering with climate",
    selectRandomImage(),
    1.5,
    "kmeans",
    "h2",
...
function makekmeansPage() {
  ...
  var contentsection = makeSection();
  var p = makeContentElement(
    "Visualisation of base data",
    "/img/t26.jpg",
    1.5,
    "basedata",
    "h2",
    "third",
    "/tools/kmeans/basedata"
  );
  var a = makeContentElement(
    "1D clustering with comfort indices and average annual data",
    "/img/t27.jpg",
    1.5,
    "1dannual",
    "h2",
    "third",
    "/tools/kmeans/annual1d"
  );
  var c = makeContentElement(
    "1D clustering with comfort indices and average monthly data",
    "/img/t28.jpg",
    1.5,
    "2dannual",
    "h2",
    "third",
    "/tools/kmeans/monthly1d"
  );
  contentsection.appendChild(p);
  contentsection.appendChild(a);
  contentsection.appendChild(c);
  ...
  var contentsection = makeSection();
  var p = makeContentElement(
    "3D clustering {temp, hr, viento} and average annual data",
    "/img/t29.jpg",
    1.5,
    "gridded1",
    "h2",
    "third",
    "/tools/kmeans/annual3d"
  );
  var a = makeContentElement(
    "3D clustering {temp, hr, viento} and average monthly data",
    "/img/t30.jpg",
    1.5,
    "gridded2",
    "h2",
    "third",
    "/tools/kmeans/monthly3d"
  );
...
function mainPageLanding() {
  ...
  var subtitlediv = makeFloatTextDiv(
    "Climate driven building design and construction in the tropics;",
    "subtitle",
    "h2",
    "",
    ""
  ...
  var basetitlediv = makeFloatTextDiv(
    "Tools and strategies to improve human comfort in Colombia",
    "subtitle",
    "h4",
    "",
    ""
...
function getDisclaimerData(file) {
  d3.queue().defer(d3.text, file).await(addDisclaimerText);
}
...
function makeRefsPage() {
  ...
  contentCol.appendChild(
    makeText("Licence, legal, references and data sources", "h1")
  );
  ...
  contentCol.appendChild(
    makeTextLink(
      "clima-colombia.org is licensed under a Creative Commons Attribution-NonCommercial 4.0 International License",
  ...
  contentCol.appendChild(
    makeText(
      "Ren, H.S., 2004. Construction of a generalized psychrometric chart for different pressures. International Journal of Mechanical Engineering Education, 32(3), pp.212-222.",
      "p"
    )
  );
  contentCol.appendChild(
    makeText(
      "Stull, R., 2016. Practical Meteorology: an algebra based survey of atmospheric science. BC Campus.",
      "p"
    )
  );
  contentCol.appendChild(
    makeText("ISO 7730:2005 - Ergonomics of the thermal environment", "p")
  );
  contentCol.appendChild(
    makeTextLink(
      "Hoyt Tyler, Schiavon Stefano, Piccioli Alberto, Moon Dustin, and Steinfeld Kyle, 2013, CBE Thermal Comfort Tool. Center for the Built Environment, University of California Berkeley",
  ...
  contentCol.appendChild(
    makeTextLink(
      "CRU-TS v3.10.01 Historic Climate Database",
  ...
  contentCol.appendChild(
    makeTextLink(
      "EnergyPlus Weather Files in climaJSON - the new standard for online interoperable climate data",
      "/data/json/allEPW",
      "p"
    )
  );
  ...
  contentCol.appendChild(
    makeTextLink("climaJSON format specifcation", "/tools/climaschema/", "p")
  );
  contentCol.appendChild(
    makeTextLink(
...
function makeRecursosPage() {
  ...
  contentCol.appendChild(
    makeTextLink(
      "Materials, construction systems and energy efficiency",
      "/materials.html",
      "p"
    )
  );
  ...
  contentCol.appendChild(
    makeTextLink("Green envelopes", "/envolVerde.html", "p")
  );
  contentCol.appendChild(
    makeTextLink("Design and evaluation", "/disenoEval.html", "p")
  );
  contentCol.appendChild(
    makeTextLink("Policy and theory", "/politTheoria.html", "p")
  );
  contentsection.appendChild(contentCol);
...
function getRefData(file) {
  d3.queue().defer(d3.text, file).await(writerefs);
}
function makeDataPage() {
  ...
  contentCol.appendChild(
    makeTextLink("Go to map to download individual city files.", "#MAP")
  );
  contentCol.appendChild(
    makeText(
      "The *.epw files were generated using the clima-colombia.org SynthYear™ synthetic year method that is designed to function with the quality of data availble in Colombia.",
      "p"
    )
  );
  contentCol.appendChild(
    makeText(
      "The clima-colombia.org SynthYear™ is adapted from the published TMY (typical meteorological year).",
      "p"
    )
  );
  contentCol.appendChild(
    makeText(
      "Raw data is from Colombia's IDEAM (Instituto de Hidrología, Meteorología y Estudios Ambientales) comprised of 10 and 60 minute readings for surface temperature, relative humidity, wind direction, wind speed, precipitation and global horizontal radiation.",
      "p"
    )
  );
  contentCol.appendChild(
    makeText(
      "Gaps in this base data are filled with data from NOAA's (National Oceanic and Atmospheric Administration) integrated surface database (ISD).",
      "p"
    )
  );
  contentCol.appendChild(
    makeText(
      "From these values the following derived variables are calculated : dew point temperature, extra-terrestrial horizontal radiation, direct horizontal radiation, diffuse horizontal radiation,",
      "p"
    )
  );
  contentCol.appendChild(
    makeText(
      "For each city, the clima-colombia.org SynthYear™ data is synthesised  using a data from stations within a 50 km radius and +- 100m of altitude of the city. Should insufficent data exist in this range, the horizontal limits are expanded to include stations within the same climatic and geographical region.",
      "p"
    )
  );
  ...
  contentCol.appendChild(
    makeTextLink(
      "Graphic summaries that show the fields calculated using clima-colombia.org SynthYear™ synthetic year method for each city are avaliable here.",
      "/data/epw/rc3_0/graphs/rc3GraphSummary.zip",
      "p"
    )
  );
  ...
  contentCol.appendChild(
    makeText(
      "The approach uses emprical data, rather than simulated data and is designed to more accurately reflect the tropical conditions in Colombia.",
      "p"
    )
  );
  contentCol.appendChild(
    makeText(
      "Remaining fields required to complete the *.eow file are taken from the closest city in the climate.onebuilding.org *.epw dataset",
      "p"
    )
  );
  contentCol.appendChild(
    makeTextLink(
      "Click here to see a map of stations associated with each city.",
      "/tools/cityGroups",
      "p"
    )
  );
  contentCol.appendChild(
    makeText(
      "The clima-colombia.org SynthYear™ method is in constant review and the data is provided to the end users of the Service 'as is'.",
      "p"
    )
  );
  contentCol.appendChild(
    makeTextLink(
      "All users should revise the DATA DISCLAIMERS AND COPYRIGHT before use.",
      "/tools/refs/refs.html",
      "p"
    )
  );
  ...
  contentCol.appendChild(
    makeText(
      "Send comments, questions, requests and bug reports to: info[at]clima-colombia.org",
      "p"
    )
  );
  content.insertBefore(contentsection, content.firstChild);
