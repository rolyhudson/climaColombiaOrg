...
h=w*0.77;
  ...
  getData("../../../data/classifications/ColombianClustering/"+clusters+"/"+currentDimType+"clusters.json"); 
  setUpMapping();
  //set up the 3d cluster view
  //run3dClusterView("../../data/classifications/TropicalClustering/"+clusters+"/Colombia/"+"mesh.txt");
}
function updateControls(){
	updateText("Averaged "+ title +" k-means clustering study: Single Comfort Index Dimensions","gridtitle");
...
function clusterChange(){
	...
	clusters = e.value;
	var zone = document.getElementById('countrySelector');
	maxField = clusters-1;
	switch(0)
	{
		case 0://colombia 
