...
h=w*0.77;
  ...
  getData("../../../data/classifications/ColombianClustering/"+climatedata); 
  setUpMapping();
}
function updateControls(){
	updateText(title +" base data","gridtitle");
...
function countryChange(){
	...
	switch(e.selectedIndex)
	{
		...
		setMap("../../data/maps/COL_adm0CountryBoundary.json",-69.5,7.7,2700);
  		getData("../../data/classifications/statsColombiaAverages.json");
		break;
		case 1://france 
...
function defineScaleBar(){
	...
	if(currentField.description.indexOf("class")>-1||currentField.description.indexOf("beaufort")>-1)
	{
	...
	else
	{
		...
		if(currentField.description.indexOf("IDEAM comfort index")>-1)barlabels.reverse();
	}
	updateText(currentField.description+" "+currentField.units,"scaleTitle");
