...
h=w*0.77;
  ...
  run3dClusterView("../../../data/classifications/ColombianClusteringAverageYear/"+clusters+"/mesh.txt");
}
function updateControls(){
	updateText("Averaged "+ title +" k-means clustering study Average year: 3D data points {temp, rh, wind}","gridtitle");
...
function clusterChange(){
	...
	{
		case 0://colombia 
  		getData("../../../data/classifications/ColombianClusteringAverageYear/"+clusters+"/"+clusters+"clusters.json"); 
  		getClusterMeshData("../../../data/classifications/ColombianClusteringAverageYear/"+clusters+"/mesh.txt");
		break;
		case 1://tropics
  		getData("../../data/classifications/TropicalClustering/"+clusters+"/"+clusters+"clusters.json");
  		//getClusterMeshData("../../data/classifications/TropicalClustering/"+clusters+"/mesh.txt");
